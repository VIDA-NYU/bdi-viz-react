...
@tool
def read_candidates(matching_task: MatchingTask, source_column: str):
    """
    Read the candidates from the matching task object
...
@tool
def update_candidates(matching_task: MatchingTask, candidates: dict):
    """
    Update the candidates in the matching task object.
